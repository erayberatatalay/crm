<?php
/* Smarty version 4.5.3, created on 2025-04-21 16:18:27
  from 'C:\xampp\htdocs\istencicrm\cache\themes\SuiteP\modules\RC_ProductPricing\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_680653b38cc581_66693839',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2b3c8a2abc293f431031dfcccc7d9d59ea9d745a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\istencicrm\\cache\\themes\\SuiteP\\modules\\RC_ProductPricing\\EditView.tpl',
      1 => 1745245107,
      2 => 'file',
    ),
  ),
...
" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_KEY'];?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=RC_ProductPricing'); return false;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_LABEL'];?>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="rc_productpricing_aos_products_name">


<div class="col-xs-12 col-sm-2 label" data-label="LBL_RC_PRODUCTPRICING_AOS_PRODUCTS_FROM_AOS_PRODUCTS_TITLE">
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_RC_PRODUCTPRICING_AOS_PRODUCTS_FROM_AOS_PRODUCTS_TITLE','module'=>'RC_ProductPricing'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="rc_productpricing_aos_products_name" colspan='3' >
<?php echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>


<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
" class="sqsEnabled" tabindex="0" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
" size="" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['value'];?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['id_name'];?>
" 
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['id_name'];?>
" 
value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_productsaos_products_ida']['value'];?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
" id="btn_<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
...
"
onclick='open_popup(
"<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['module'];?>
", 
600, 
400, 
"", 
true, 
false, 
{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"rc_productpricing_aos_productsaos_products_ida","name":"rc_productpricing_aos_products_name"}}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
" id="btn_clr_<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label'=>"LBL_ACCESSKEY_CLEAR_RELATE_TITLE"),$_smarty_tpl);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
', '<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['id_name'];?>
...
_<?php echo $_smarty_tpl->tpl_vars['fields']->value['rc_productpricing_aos_products_name']['name'];?>
']) != 'undefined'",
		enableQS
);
<?php echo '</script'; ?>
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'description', 'text', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DESCRIPTION','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'deleted', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DELETED','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_ID','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'day_count', 'int', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DAY_COUNT','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'price', 'currency', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_PRICE','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'currency_id', 'currency_id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CURRENCY','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'rc_productpricing_aos_products_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_RC_PRODUCTPRICING_AOS_PRODUCTS_FROM_AOS_PRODUCTS_TITLE','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'rc_productpricing_aos_products_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_RC_PRODUCTPRICING_AOS_PRODUCTS_FROM_AOS_PRODUCTS_TITLE','module'=>'RC_ProductPricing','for_js'=>true),$_smarty_tpl);?>
', 'rc_productpricing_aos_productsaos_products_ida' );
<?php echo '</script'; ?>
><?php echo '<script'; ?>
 language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_rc_productpricing_aos_products_name']={"form":"EditView","method":"query","modules":["AOS_Products"],"group":"or","field_list":["name","id"],"populate_list":["rc_productpricing_aos_products_name","rc_productpricing_aos_productsaos_products_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"E\u015fle\u015fme Yok"};<?php echo '</script'; ?>
>
<?php }
}
