...
<div class="col-xs-12 col-sm-12 detail-view-row-item" data-field="currency_id">
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="product_image">
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="varchar" field="product_image" >
