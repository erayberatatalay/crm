...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='day_count_advanced'>{sugar_translate label='LBL_DAY_COUNT' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.day_count_advanced.value) <= 0}
{assign var="value" value=$fields.day_count_advanced.default_value }
{else}
{assign var="value" value=$fields.day_count_advanced.value }
{/if}  
<input type='text' name='{$fields.day_count_advanced.name}' 
    id='{$fields.day_count_advanced.name}' size='30' 
    ...
    value='{$value}' title='' tabindex='-1' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='price_advanced'>{sugar_translate label='LBL_PRICE' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.price_advanced.name}' 
    ...
    value='{$value}' title='' tabindex='-1' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='modified_user_id_advanced'>{sugar_translate label='LBL_MODIFIED' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
...
{html_options name='modified_user_id_advanced[]' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.modified_user_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_date_modified_advanced) && !empty($smarty.request.date_modified_advanced)}{$smarty.request.date_modified_advanced}{else}{$smarty.request.range_date_modified_advanced}{/if}' title=''   tabindex='-1'  size="11" class="dateRangeInput">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_modified_advanced }' title=''  tabindex='-1' size="11" class="dateRangeInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.date_modified_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_date_modified_advanced }' title=''  tabindex='-1' size="11" class="dateRangeInput" maxlength="10">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_by_advanced'>{sugar_translate label='LBL_CREATED' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
...
{html_options name='created_by_advanced[]' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.created_by_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='rc_productpricing_aos_products_name_advanced'>{sugar_translate label='LBL_RC_PRODUCTPRICING_AOS_PRODUCTS_FROM_AOS_PRODUCTS_TITLE' module='RC_ProductPricing'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.rc_productpricing_aos_products_name_advanced.name}"  class="sqsEnabled"  tabindex="-1"   id="{$fields.rc_productpricing_aos_products_name_advanced.name}" size="" value="{$fields.rc_productpricing_aos_products_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.rc_productpricing_aos_productsaos_products_ida_advanced.name}" value="{$fields.rc_productpricing_aos_productsaos_products_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.rc_productpricing_aos_products_name_advanced.name}"  tabindex="-1"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.rc_productpricing_aos_products_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"rc_productpricing_aos_productsaos_products_ida_advanced","name":"rc_productpricing_aos_products_name_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.rc_productpricing_aos_products_name_advanced.name}"  tabindex="-1"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.rc_productpricing_aos_products_name_advanced.name}.value = ''; this.form.{$fields.rc_productpricing_aos_productsaos_products_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
